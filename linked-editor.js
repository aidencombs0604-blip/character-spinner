(function () {
    ...
    function renderSelectedWheel() {
        ...
        if (deleteButton) {
            deleteButton.addEventListener('click', () => deleteWheel(id));
        }
    ...
    function deleteWheel(id) {
        ...
        Object.values(app.wheels).forEach(wheel =>
    ...
    function init() {
        ...
        window.addEventListener('wheel-data-restored', () => {
            renderWheelOptions(select.value || 'main');
        });
